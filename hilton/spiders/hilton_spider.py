...
class HiltonSpider(scrapy.Spider):
    name='hilton'
    hilton_codes={u'NGBNCDI': u'DoubleTree by Hilton Hotel Ningbo - Chunxiao',}
    ...
    def start_requests(self):
        ...
        for url in self.start_urls:
            ...
            yield scrapy.Request(url,self.parse,dont_filter=True,meta={'date':self.today,'room_availability':room_availability})
    def parse(self,response):
        ...
        yield scrapy.FormRequest.from_response(response,formdata=formdata,callback=self.after_query,dont_filter=True,meta={'date':new_date_for_next_request,'room_availability':response.meta['room_availability']})
    ...
    def after_query(self,response):
        ...
        for tr in trs:
            ...
            if checkin_date:
                print checkin_date+'-----'+redeemed_points
